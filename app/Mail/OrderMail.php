...
class OrderMail extends Mailable
{
    ...
    public function __construct(public string $email,public string $surname,public string $lastname,public string $city,public string $residentialAddress,public string $phone1,
        ...
        public string $toContactPhone,public string $toContactAddress,public string $segment,public $delivery_address,public $uin,public $delivery,public $total_order,public $deliveryAmount,
